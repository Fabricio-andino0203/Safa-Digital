        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            @php
                $navItems = [
                    ...
                    ['route' => 'calculadora.index','label' => 'Calculadora Stickers','icon' => 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M6 21h12a2 2 0 002-2V5a2 2 0 00-2-2H6a2 2 0 00-2 2v14a2 2 0 002 2z'],
            ...
            @foreach($navItems as $item)
                @php
                    ...
                    if (auth()->check() && $modulo !== 'dashboard') {
                        $permisoRequerido = ($modulo === 'tesoreria') ? 'caja' : (($modulo === 'calculadora') ? 'inventario' : $modulo);
