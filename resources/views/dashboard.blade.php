...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="bg-white border border-neutral-200 rounded-2xl shadow-sm p-6 flex flex-col justify-between hover:border-neutral-900 transition-all">
            ...
            <div>
                <span class="text-3xl font-extrabold text-blue-600 tracking-tight">{{ $pedidosActivos }}</span>
                <p class="text-xs text-neutral-500 mt-1">En curso o esperando entrega</p>
            </div>
        </div>
        ...
        <div class="bg-white border border-neutral-200 rounded-2xl shadow-sm p-6 flex flex-col justify-between hover:border-neutral-900 transition-all">
            <div class="flex items-center justify-between mb-4">
                <span class="text-xs font-bold text-neutral-400 uppercase tracking-wider">Facturado Hoy</span>
                <span class="p-2 bg-green-50 text-green-600 rounded-xl">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                </span>
            </div>
            <div>
                <span class="text-3xl font-extrabold text-green-600 tracking-tight">L. {{ number_format($ventasHoy, 2) }}</span>
                <p class="text-xs text-neutral-500 mt-1">Pedidos facturados el día de hoy</p>
            </div>
        </div>
