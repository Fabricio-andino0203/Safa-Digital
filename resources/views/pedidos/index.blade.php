...
@section('content')
<div x-data="kanbanBoard()" @paste.window="handlePaste($event)" @producto-seleccionado.window="seleccionarProductoDesdeBuscadorGlobal($event.detail)" class="h-full flex flex-col">
    <!-- Header de Controles -->
...
<script>
    function kanbanBoard() {
        return {
            ...
            agregarDetalle() {
                this.form.detalles.push({ tipo_producto: 'Inventario', producto_variante_id: '', nombre_libre: '', descripcion_libre: '', cantidad: 1, precio_venta: 0 });
            },
